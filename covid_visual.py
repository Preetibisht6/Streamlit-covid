...
imageurl = 'https://raw.githubusercontent.com/Preetibisht6/Streamlit-covid/main/covidimage.jpg'
u = ulr.urlopen(imageurl)
...
def long_running_function():
    return 1
covid_df = pd.read_csv(r'https://raw.githubusercontent.com/Preetibisht6/Streamlit-covid/main/covidmaster.csv')
...
#india_ds=json.load(open("D:\FinalProject\india.geojson"))
...
#                         geojson = india_ds,color = 'Active Cases', color_continuous_scale = "reds", 
#                         range_color = (0,200000), fitbounds='geojson')
