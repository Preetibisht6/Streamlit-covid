...
image = Image.open(r"F:\Preeti\IIRS class work\covidimage.jpg")
...
def long_running_function():
    return 1
covid_df = pd.read_csv(r'F:\Preeti\IIRS class work\covidmaster.csv')
...
if not st.checkbox('Hide Animation', False, key = 6):
    file_ = open("F:\Preeti\IIRS class work\COVID-19 India.gif", "rb")
    contents = file_.read()
